...
public class Workbench extends BasePage {
	...
	public Workbench MasterCheckBox() {
		ui_waitForElementToAppear(Master_checkbox, 10);
		ui_click(Master_checkbox, "Masterchechkbox");
		return this;
	}
	public Workbench ExportBtn() {
		ui_waitForElementToAppear(export_btn,10);
	...
	////span[Class=”text” and contains(.,’Yayy! The file has been exported’)]//
	public Workbench ColumnBtn() {		
		ui_waitForElementToAppear(Column_btn,10);
	...
	public Workbench EditBtn() {
		ui_waitForElementToAppear(Edit_btn,5);
	...
	public Workbench SelectSuggetionDrpdown() {
		ui_waitForElementToAppear(suggetion_DropDown,10);
	...
	public Workbench SelectbulkUpdatDropdownOption() {
		ui_waitForElementToAppear(bulkUpdatDropdownOption,4);
